---
type: post
title: "Tip 205 - Explicitly Name Logic API Connections"
...
Notice how `connectionId` is a concatination of the resource type and name, and the `id` is the same as the `api/id`.

#### Conclusion

It wasn't entirely clear what specificaly needed changing in what locations to modify the defaults. Hopefully, this tip will save you the hit-n-miss process I went through.
