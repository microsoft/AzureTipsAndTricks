...
:bulb: Learn more : [PowerShell in Azure Data Studio](https://docs.microsoft.com/sql/azure-data-studio/powershell-extension?WT.mc_id=docs-azuredevtips-micrum). 

:::

## Azure Data Studio

Managing data in Azure is a very frequent task for most Azure developers. [Azure Data Studio](https://docs.microsoft.com/sql/azure-data-studio/what-is?WT.mc_id=docs-azuredevtips-micrum) is a great, free, cross-platform tool to do just that. Azure Data Studio offers a modern editor experience for managing data across multiple sources with fast intellisense, code snippets, source control integration, and an integrated terminal.

<img :src="$withBase('/files/41azuredatastudio.png')">

(Azure Data Studio)

And now, you can use [PowerShell in Azure Data Studio](https://docs.microsoft.com/sql/azure-data-studio/powershell-extension?WT.mc_id=docs-azuredevtips-micrum). This means that you can reuse your PowerShell skills and that you can execute your favorite scripts.
...
* Azure Data Studio. You can download a free copy [here](https://docs.microsoft.com/sql/azure-data-studio/download?WT.mc_id=docs-azuredevtips-micrum)
* Make sure that you have the latest version of PowerShell Core installed on your machine. You can download it [here](https://github.com/PowerShell/PowerShell/releases/?WT.mc_id=code-azuredevtips-micrum)
...
#### Conclusion
[Azure Data Studio](https://docs.microsoft.com/sql/azure-data-studio/what-is?WT.mc_id=docs-azuredevtips-micrum) is a really powerful tool for working with data. The [PowerShell extension for Azure Data Studio](https://docs.microsoft.com/sql/azure-data-studio/powershell-extension?WT.mc_id=docs-azuredevtips-micrum) gives you the power to use your PowerShell skills in the world of data. It helps you by adding debug support, auto-complete, script problem analytics, function definition and more. Go and check it out!
