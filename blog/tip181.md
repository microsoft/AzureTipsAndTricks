...
If you are building ASP.NET Core applications, you can use [**ConfigureServices**](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/extensions/Microsoft.Extensions.Azure#azure-client-library-integration-for-aspnet-core) to coalesce configuration data from multiple sources and expose it via dependency injection to your controllers.
