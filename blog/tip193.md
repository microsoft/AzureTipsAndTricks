 ...
 * The [core Azure SDK](github.com/Azure/azure-sdk-for-go) for Go
 * The [Blob Storage SDK](github.com/Azure/azure-storage-blob-go) for Go
 * The [File Storage SDK](github.com/Azure/azure-storage-file-go) for Go
 * The [Storage Queue SDK](github.com/Azure/azure-storage-queue-go) for Go
 * The [Event Hub SDK](github.com/Azure/azure-event-hubs-go) for Go
 * The [Service Bus SDK](github.com/Azure/azure-service-bus-go) for Go
 * The [Application Insights SDK](github.com/Microsoft/ApplicationInsights-go) for Go
