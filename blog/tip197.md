...
Azure API Management is a very powerful and versatile product. In this post, you've seen only some of its capabilities. You can do a lot more with API Management, like version your API, secure it and monitor it. Go and check it [out](https://azure.microsoft.com/en-us/services/api-management?WT.mc_id=azure-azuredevtips-micrum)!
