...
#### Identify irisis like a Machine
 ...
 This is [part 2](tip175/) of a two part post on ML.NET inspired by Luis Quintanilla’s [article](http://luisquintanilla.me/2018/08/21/serverless-machine-learning-mlnet-azure-functions/) about using ML.NET with Azure Functions, where he took these two great ideas and combined them. Picking up [with Part 1](tip145/), you are going to create a new Azure Function project using Visual Studio.
